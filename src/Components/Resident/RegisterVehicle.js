    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPIFlag && <HandleAPI data={data} funcName="registerVehicle" responseData = {this.getResponseData}/>}
                {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="registerVehicleCreate" responseData = {this.getCreateResponseData}/>}
                {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.tableData[this.state.editdata].vehicleLicense} funcName = "registerVehicleDelete" responseData = {this.getDeleteResponseData} />}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "registerVehicleEdit" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
