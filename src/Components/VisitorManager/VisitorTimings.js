...
class VisitorTimings extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            // tableData: [
            //     {
            //         "data": "Monday - 6:00 AM to 6:00 PM",
            //     },
            //     {
            //         "data": "Tuesday - 6:00 AM to 6:00 PM",
            //     },
            //     {
            //         "data": "Wednesday - 6:00 AM to 6:00 PM",
            //     },
            //     {
            //         "data": "Thursday - 6:00 AM to 6:00 PM",
            //     },
            //     {
            //         "data": "Friday - 6:00 AM to 6:00 PM",
            //     },
            //     {
            //         "data": "Saturday - 8:00 AM to 8:00 PM",
            //     },
            //     {
            //         "data": "Sunday - 8:00 AM to 8:00 PM",
            //     },
            // ],
            createData: [{
                "data": "",
    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="visitorTimingsCreate" responseData = {this.getCreateResponseData}/>}
                {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.tableData[this.state.editdata].name} funcName = "visitorTimingsDelete" responseData = {this.getDeleteResponseData} />}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "visitorTimingsEdit" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
