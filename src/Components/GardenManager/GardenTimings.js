    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="gardenTimingsCreate" responseData = {this.getCreateResponseData}/>}
                {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.tableData[this.state.editdata].name} funcName = "gardenTimingsDelete" responseData = {this.getDeleteResponseData} />}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "gardenTimingsEdit" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
