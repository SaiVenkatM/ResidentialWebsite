...
class report extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            barChartData: [
                { year: '2018', GardenEvents: 5, WalkingTrailEvents: 3 },
                { year: '2020', GardenEvents: 9, WalkingTrailEvents: 7 },
                { year: '2022', GardenEvents: 15, WalkingTrailEvents: 13 },
            ],
            pieChartData: [
                { name: 'Number of Gardens', value: 5 },
                { name: 'Number of Walking Trails', value: 6 },
            ],
            pieChartColors: ['#fada5e', '#ff2800'],
            tableData: [],
            handleAPIFlag: false,
                ...
                <div className='report-row'>
                    <div class="report-column">
                        <BarChart width={480} height={300} data={this.state.barChartData}>
                            ...
                            <YAxis label={{ value: 'Number of Events', angle: -90, position: 'LeftBotton' }} />
                            <Tooltip />
                            <Bar dataKey="GardenEvents" fill="#0000ff" />
                            <Bar dataKey="WalkingTrailEvents" fill="#ff0000" />
                        </BarChart>
                    </div>
                    <div class="report-column">
                        <PieChart width={500} height={300}>
                            <text x={90} y={20} >
                                Garden Amenity Count
                            </text>
