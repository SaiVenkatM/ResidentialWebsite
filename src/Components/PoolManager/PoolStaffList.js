...
class PoolStaffList extends Component {
    ...
    getResponseData = (data) => {
        ...
        console.log("get response data function in pool staff list", data)
    ...
    handleEditFormValidation() {
        ...
        if (!inputFields[3]) {
            validateForm = false;
            editErrors["PoolName"] = "Pool Name field cannot be empty";
        } else {
            editErrors["PoolName"] = "";
        }
        ...
        if (inputFields[3] && !inputFields[3].match(/^[A-Za-z0-9]+$/)) {
            validateForm = false;
            editErrors["PoolName"] = "Please provide a valid PoolName.";
        }
    ...
    handleFormValidation() {
        ...
        if (inputFields["WorkerType"] && !inputFields["WorkerType"].match(/^[A-Za-z]+$/)) {
            validateForm = false;
            errors["WorkerType"] = "Please provide a WorkerType.";
        }

        if (!inputFields["PoolName"]) {
            validateForm = false;
            errors["PoolName"] = "Pool Name field cannot be empty";
        } else {
            errors["PoolName"] = "";
        }

        if (inputFields["PoolName"] && !inputFields["PoolName"].match(/^[A-Za-z0-9]+$/)) {
            validateForm = false;
            errors["PoolName"] = "Please provide a valid PoolName.";
        }
    ...
    render() {
        ...
        let data =  {
            ...
            'poolName':this.state.inputFields['PoolName'],
        ...
        let createPayload = {
            ...
            'poolName':this.state.createData.PoolName,
        ...
        return (
            <>
                ...
                <div class="container1">
                    ...
                    {this.state.editAction && (
                        ...
                        >
                            <form>
                                ...
                                <label>Enter Pool Name:</label><br />
                                <input type="text"
                                    defaultValue={this.state.tableData[this.state.editdata][3]}
                                    onChange={this.handleInputChange.bind(this, "poolName")} /><br />
                                {this.state.showEditError && <><span className="showErrors">{this.state.editErrors["PoolName"]}</span><br /></>}
                    ...
                    {this.state.createAction && (
                        ...
                        >
                            <form>
                                ...
                                <label>Enter Pool Name:</label><br />
                                <input type="text"
                                    defaultValue={this.state.createData.PoolName}
                                    onChange={this.handleCreate.bind(this, "PoolName")} /><br />
                                {this.state.showError && <><span className="showErrors">{this.state.errors["PoolName"]}</span><br /></>}
                                <label>Enter Schedule:</label><br />
                                <input type="text"
                    ...
                    {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "PoolManagerStaffListAPI" responseData = {this.getResponseData}/>}
                    {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="PoolManagerStaffListCreateAPI" responseData = {this.getCreateResponseData}/>}
                    {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.deleteVal} funcName = "PoolManagerStaffListDeleteAPI" responseData = {this.getDeleteResponseData} />}
                    {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "PoolManagerStaffListEditAPI" responseData = {this.getEditResponseData} />}
                </div>
            </>
        );
    }
