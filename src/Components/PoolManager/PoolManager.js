...
import poolEvents from '../../images/poolEvents.png';
import poolTimings from '../../images/poolTimings.webp';
                ...
                <div class="service-container3">
                    <div class="service-row">
                        <div class="service-column">
                            <img src={poolEvents} alt="" class="image-service" />
                        </div>
                        <div class="service-column2">
                            <h2><Link to="/poolEvents">EVENTS</Link></h2>
                            <p>Schedule the events conducted in the pool where each event will have event name, time and date of the event.
                                Perform crud operations like add, edit events. </p>
                        </div>
                    </div>
                    <div class="service-row">
                        <div class="service-column">
                        ...
                        <div class="service-column2">
                            <h2><Link to="/advertising">Advertising for Events</Link></h2>
                    ...
                    <div class="service-row">
                        <div class="service-column">
                            <img
                                src={poolTimings} alt="" class="image-service" />
                        </div>
                        <div class="service-column2">
                            <h2><Link to="/poolTimings">Pool Timings</Link></h2>
                            <p>Schedule of the open time of the pool. Perform crud operations like edit, add timings. </p>
                        </div>
                    </div>
                    <div class="service-row">
                        <div class="service-column">
                            <img
                                src={poolStaff} alt="" class="image-service" />
                        </div>
                        <div class="service-column2">
                            <h2><Link to="/poolManagerStaffList">STAFF</Link></h2>
                    ...
                    <div class="service-row">
                        <div class="service-column">
                            <img
                                src={manageResidents} alt="" class="image-service" />
                        </div>
                        <div class="service-column2">
                    ...
                    <div class="service-row">
                        ...
                        <div class="service-column2">
                            <h2><Link to="/poolManager/report">Dashboard</Link></h2>
