    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="pooolTimingsCreate" responseData = {this.getCreateResponseData}/>}
                {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.tableData[this.state.editdata].name} funcName = "poolTimingsDelete" responseData = {this.getDeleteResponseData} />}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "poolTimingsEdit" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
