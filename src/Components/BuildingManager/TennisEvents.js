...
class TennisEvents extends Component {
    ...
    getResponseData = (data) => {
        ...
        console.log("get response data function in tennis events", data)
    ...
    handleEditFormValidation() {
        ...
        if (!inputFields[0]) {
            validateForm = false;
            editErrors["TennisEvents"] = "Tennis Events cannot be empty";
        } else {
            editErrors["TennisEvents"] = "";
        }

        if (inputFields[0] && !inputFields[0].match(/^[A-Za-z]+$/)) {
            validateForm = false;
            editErrors["TennisEvents"] = "Please provide a Tennis Events(special characters and space not allowed).";
        }
    ...
    handleFormValidation() {
        ...
        if (!inputFields["TennisEvents"]) {
            validateForm = false;
            errors["TennisEvents"] = "Tennis Events cannot be empty";
        } else {
            errors["TennisEvents"] = "";
        }

        if (inputFields["TennisEvents"] && !inputFields["TennisEvents"].match(/^[A-Za-z]+$/)) {
            validateForm = false;
            errors["TennisEvents"] = "Please provide a Tennis Events.";
        }
        ...
        if (inputFields["EventID"] && !inputFields["EventID"].match(/^\d+$/)) {
            validateForm = false;
            errors["EventID"] = "Please provide a valid Event ID.";
        }
        ...
        //     validateForm = false;
        //     errors["MatchDate"] = "Please provide a valid Match Date.";
        // }
    ...
    render() {
        ...
        let data =  {
            'tevent': this.state.inputFields["TennisEvents"],
        ...
        let createPayload = {
            'tevent':this.state.createData.TennisEvents,
        ...
        return (
            <>
                ...
                <div class="container1">
                        ...
                        >
                            <form>
                                ...
                                <input type="text"
                                    ...
                                    onChange={this.handleInputChange.bind(this, "tevent")} /><br />
                                {this.state.showEditError && <><span className="showErrors">{this.state.editErrors["TennisEvents"]}</span><br /></>}
                    ...
                    {this.state.createAction && (
                        ...
                        >
                            <form>
                                <label>Enter Tennis Events:</label><br />
                                <input type="text"
                                    defaultValue={this.state.createData.TennisEvents}
                                    onChange={this.handleCreate.bind(this, "TennisEvents")} /><br />
                                {this.state.showError && <><span className="showErrors">{this.state.errors["TennisEvents"]}</span><br /></>}
                    ...
                    {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "BTennisEventsAPI" responseData = {this.getResponseData}/>}
                    {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="BTennisEventsCreateAPI" responseData = {this.getCreateResponseData}/>}
                    {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.deleteVal} funcName = "BTennisEventsDeleteAPI" responseData = {this.getDeleteResponseData} />}
                    {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "BTennisEventsEditAPI" responseData = {this.getEditResponseData} />}
                </div>
            </>
        );
    }
