...
class ResidentServicesSuperAdmin extends Component {
                    ...
                    <div class="service-container3">
                        <div class="service-row">
                            ...
                            <div class="service-column2">
                                <h2><Link to="/superAdmin/resident/residentProfile">MY PROFILE</Link></h2>
                        ...
                        <div class="service-row">
                            ...
                            <div class="service-column2">
                                <h2><Link to="/superAdmin/resident/registerVehicle">Register Vechicle</Link></h2>
                        ...
                        <div class="service-row">
                            ...
                            <div class="service-column2">
                                <h2><Link to="/superAdmin/resident/myPayment">MY PAYMENTS</Link></h2>
                        ...
                        <div class="service-row">
                            ...
                            <div class="service-column2">
                                <h2><Link to="/superAdmin/resident/subscriptions">MY SUBSCRIPTIONS</Link></h2>
...
export default ResidentServicesSuperAdmin;