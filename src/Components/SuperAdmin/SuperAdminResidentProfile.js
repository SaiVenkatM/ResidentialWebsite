...
class SuperAdminResidentProfile extends Component {
        ...
        return (
            <>
                ...
                <div class="container1">
                    ...
                    {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "superAdminResidentProfiles" responseData = {this.getResponseData}/>}
                </div>
            </>
        );
    }
...
export default SuperAdminResidentProfile;