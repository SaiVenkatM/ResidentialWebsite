...
class SuperAdminResidentMyPayment extends Component {
        ...
        return (
            <>
                ...
                <div class="container1">
                    ...
                    {this.state.handleAPIFlag && <HandleAPI data={insertData} funcName="superAdminResidentPaymentHistory" responseData = {this.getResponseData}/>}
                </div>
            </>
        );
    }
...
export default SuperAdminResidentMyPayment;