...
class CabinServices extends Component {
                ...
                <div class="service-container3">
                    <div class="service-row">
                        ...
                        <div class="service-column2">
                            <h2><Link to="/cabin/servicesRequested">REQUESTS</Link></h2>
                    ...
                    <div class="service-row">
                        ...
                        <div class="service-column2">
                            <h2><Link to="/cabin/manageServices">MANAGE SERVICES</Link></h2>
                    ...
                    <div class="service-row">
                        ...
                        <div class="service-column2">
                            <h2><Link to="/cabin/cabinList">LEASE DETAILS OF RESIDENTS</Link></h2>
