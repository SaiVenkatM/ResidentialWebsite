...
class CabinList extends Component {
    ...
    handleEditFormValidation() {
        ...
        if (!inputFields[0]) {
            validateForm = false;
            editErrors["CabinNumber"] ="Cabin Number cannot be empty";
        } else {
            editErrors["CabinNumber"] = "";
        }

        if (inputFields[0] && !inputFields[0].match(/^[A-Za-z0-9]+$/)) {
            validateForm = false;
            editErrors["CabinNumber"] = "Please provide a valid number.";
        }
    ...
    handleFormValidation() {
        ...
        if (!inputFields["CabinNumber"]) {
            validateForm = false;
            errors["CabinNumber"] = "Cabin Number cannot be empty";
        } else {
            errors["CabinNumber"] = "";
        }

        if (inputFields["CabinNumber"] && !inputFields["CabinNumber"].match(/^[A-Za-z0-9]+$/)) {
            validateForm = false;
            errors["CabinNumber"] = "Please provide a valid number.";
        }
    ...
    render() {
        ...
        let data =  {
            'apttype': this.state.inputFields["CabinNumber"],
        ...
        let createPayload = {
            'apttype': this.state.createData.CabinNumber,
            ...
            <>
                ...
                <div class="container1">
                    ...
                    {this.state.editAction && (
                        ...
                        >
                            <form>
                                <label>Enter Cabin Number:</label><br />
                                <input type="text"
                                    defaultValue={this.state.tableData[this.state.editdata][0]}
                                    onChange={this.handleInputChange.bind(this, "apttype")} /><br />
                                {this.state.showEditError && <><span className="showErrors">{this.state.editErrors["CabinNumber"]}</span><br /></>}
                    ...
                    {this.state.createAction && (
                        ...
                        >
                            <form>
                                <label>Enter Cabin Number:</label><br />
                                <input type="text"
                                    defaultValue={this.state.createData.CabinNumber}
                                    onChange={this.handleCreate.bind(this, "CabinNumber")} /><br />
                                {this.state.showError && <><span className="showErrors">{this.state.errors["CabinNumber"]}</span><br /></>}
                                <label>Enter Room Number:</label><br />
                                <input type="text"
                    ...
                    {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "cabinreslistAPI" responseData = {this.getResponseData}/>}
                    {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="cabinreslistCreateAPI" responseData = {this.getCreateResponseData}/>}
                    {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.deleteVal} funcName = "cabinreslistDeleteAPI" responseData = {this.getDeleteResponseData} />}
                    {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "cabinreslistEditAPI" responseData = {this.getEditResponseData} />}
                </div>
            </>
        )
    }
