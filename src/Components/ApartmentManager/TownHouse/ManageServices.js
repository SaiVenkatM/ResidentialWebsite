    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "townhousemanageserviceAPI" responseData = {this.getResponseData}/>}
                {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="townhousemanageserviceCreateAPI" responseData = {this.getCreateResponseData}/>}
                {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.deleteVal} funcName = "townhousemanageserviceDeleteAPI" responseData = {this.getDeleteResponseData} />}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "townhousemanageserviceEditAPI" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
