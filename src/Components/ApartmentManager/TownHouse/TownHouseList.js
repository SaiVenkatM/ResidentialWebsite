...
class TownHouseList extends Component {
    ...
    handleEditFormValidation() {
        ...
        if (!inputFields[0]) {
            validateForm = false;
            editErrors["TownHouseNumber"] ="Town House Number cannot be empty";
        } else {
            editErrors["TownHouseNumber"] = "";
        }

        if (inputFields[0] && !inputFields[0].match(/^[A-Za-z0-9]+$/)) {
            validateForm = false;
            editErrors["TownHouseNumber"] = "Please provide a valid number.";
        }
    ...
    handleFormValidation() {
        ...
        if (!inputFields["TownHouseNumber"]) {
            validateForm = false;
            errors["TownHouseNumber"] = "Town House Number cannot be empty";
        } else {
            errors["TownHouseNumber"] = "";
        }

        if (inputFields["TownHouseNumber"] && !inputFields["TownHouseNumber"].match(/^[A-Za-z0-9]+$/)) {
            validateForm = false;
            errors["TownHouseNumber"] = "Please provide a valid number.";
        }
    ...
    render() {
        ...
        let data =  {
            'apttype': this.state.inputFields["TownHouseNumber"],
        ...
        let createPayload = {
            'apttype': this.state.createData.TownHouseNumber,
            ...
            <>
                ...
                <div class="container1">
                    ...
                    {this.state.editAction && (
                        ...
                        >
                            <form>
                                <label>Enter Town House Number:</label><br />
                                <input type="text"
                                    defaultValue={this.state.tableData[this.state.editdata][0]}
                                    onChange={this.handleInputChange.bind(this, "apttype")} /><br />
                                {this.state.showEditError && <><span className="showErrors">{this.state.editErrors["TownHouseNumber"]}</span><br /></>}
                    ...
                    {this.state.createAction && (
                        ...
                        >
                            <form>
                                <label>Enter Town House Number:</label><br />
                                <input type="text"
                                    defaultValue={this.state.createData.TownHouseNumber}
                                    onChange={this.handleCreate.bind(this, "TownHouseNumber")} /><br />
                                {this.state.showError && <><span className="showErrors">{this.state.errors["TownHouseNumber"]}</span><br /></>}
                                <label>Enter Room Number:</label><br />
                                <input type="text"
                    ...
                    {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "townhousereslistAPI" responseData = {this.getResponseData}/>}
                    {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="townhousereslistCreateAPI" responseData = {this.getCreateResponseData}/>}
                    {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.deleteVal} funcName = "townhousereslistDeleteAPI" responseData = {this.getDeleteResponseData} />}
                    {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "townhousereslistEditAPI" responseData = {this.getEditResponseData} />}
                </div>
            </>
        )
    }
