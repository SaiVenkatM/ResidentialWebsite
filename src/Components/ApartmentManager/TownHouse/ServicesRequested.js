    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "townhouseserviceAPI" responseData = {this.getResponseData}/>}
                {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="townhouseserviceCreateAPI" responseData = {this.getCreateResponseData}/>}
                {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.deleteVal} funcName = "townhouseserviceDeleteAPI" responseData = {this.getDeleteResponseData} />}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "townhouseserviceEditAPI" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
