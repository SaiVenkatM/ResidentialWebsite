...
class StudioServices extends Component {
    render() {
        return (
            <>
                <div class="container">
                ...
                <div class="service-container3">
                    <div class="service-row">
                        ...
                        <div class="service-column2">
                            <h2><Link to="/studio/servicesRequested">REQUESTS</Link></h2>
                    ...
                    <div class="service-row">
                        ...
                        <div class="service-column2">
                            <h2><Link to="/studio/manageServices">MANAGE SERVICES</Link></h2>
                    ...
                    <div class="service-row">
                        ...
                        <div class="service-column2">
                            <h2><Link to="/studio/studioList">LEASE DETAILS OF RESIDENTS</Link></h2>
