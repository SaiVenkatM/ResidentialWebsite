...
class ServicesRequested extends Component {
    ...
    handleEditFormValidation() {
        ...
        if (inputFields[0] && !inputFields[0].match(/^[A-Za-z]+$/)) {
            validateForm = false;
            editErrors["ServiceRequested"] = "Please provide a Service.";
        }
    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "studioserviceAPI" responseData = {this.getResponseData}/>}
                {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="studioserviceCreateAPI" responseData = {this.getCreateResponseData}/>}
                {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.deleteVal} funcName = "studioserviceDeleteAPI" responseData = {this.getDeleteResponseData} />}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "studioserviceEditAPI" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
