    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPIFlag && <HandleAPI data = {data} funcName = "studiomanageserviceAPI" responseData = {this.getResponseData}/>}
                {this.state.handleAPICreateFlag && <HandleAPI data={createPayload} funcName="studiomanageserviceCreateAPI" responseData = {this.getCreateResponseData}/>}
                {this.state.handleAPIDeleteFlag && <HandleAPI data = {this.state.deleteVal} funcName = "studiomanageserviceDeleteAPI" responseData = {this.getDeleteResponseData} />}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[this.state.editdata]} funcName = "studiomanageserviceEditAPI" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
