...
class MyProfile extends Component {
    ...
    render() {
        ...
        let profileData = this.state.tableData.map((obj, index) => {
        ...
        return (
            <>
                ...
                {this.state.handleAPIFlagInsert && <HandleAPI data={insertData} funcName="visitorProfileInsert" responseData = {this.getResponseInsertData}/>}
                {this.state.handleAPIFlag && <HandleAPI data={data} funcName="visitorProfileGet" responseData = {this.getResponseData}/>}
                {this.state.handleAPIEditFlag && <HandleAPI data = {this.state.tableData[0]} funcName = "visitorProfileEdit" responseData = {this.getEditResponseData} />}
            </>
        );
    }
}
