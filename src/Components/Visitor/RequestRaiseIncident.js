...
import HandleAPI
 from "../../HandleAPI";
class RequestRaiseIncident extends Component {
    constructor(props){
        super(props);
        this.state = {
            inputFields: {},
            ...
            <>
                <div class="login-container">
                    <div class="contact-heading">
                        <h2>REQUEST / RAISE AN INCIDENT</h2>
                    </div>
                </div>
                <div>
                    <form class="contact-form" onSubmit={this.formSubmit}>
                        <span class="contact-inline">
                            ...
                            <span class="contact-spacing">
                                ...
                                <input type="text" name="email" id="email" placeholder="abc@gmail.com" value={this.props.email}/>
                            </span>
                        </span>
                        <span class="contact-inline">
                            <span class="contact-spacing">
...
export default RequestRaiseIncident;