    ...
    render() {
        ...
        return (
            <>
                ...
                {this.state.handleAPIInsertFlag && <HandleAPI data={getData} funcName="visitorSubcriptionsInsert" responseData={this.getResonseDataInsert}/>}
                {this.state.handleAPIFlag && <HandleAPI data = {getData} funcName = "visitorSubcriptions" responseData = {this.getResponseData}/>}
                {this.state.handleAPIUpdateFlag && <HandleAPI data = {data} funcName = "visitorSubcriptionsEdit" responseData = {this.getResponseUpdateData}/>}
            </>
